...
describe("Stage1 parser AST function metadata", () => {
  test("captures param count and block span", () => {
    const source = `
    ${astSrc}
    ${scannerSrc}
    ${parserSrc}
    ...
    def main() {
      var src = "def foo(a, b, c) { return 7; }";
      ...
      print node_int(parsed.arena, 3, 8);     // param count
    }
    `
